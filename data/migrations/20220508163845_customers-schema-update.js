...
exports.up = function ( knex )
{
    ...
    return knex.schema
        ...
        .createTable( "tickets", ( table ) =>
        {
            ...
            table.integer( "customer_id" ).unsigned().notNullable().references( "customer_id" ).inTable( "customers" ).onDelete( "CASCADE" ).onUpdate( "CASCADE" );
            // reference to employee that has been assigned to solve the ticket
            table.integer( "employee_id" ).unsigned().notNullable().references( "employee_id" ).inTable( "employees" ).onDelete( "CASCADE" ).onUpdate( "CASCADE" );
